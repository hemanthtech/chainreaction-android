...
public class GameInfoUtility {
   ...
   */
  public static GameSizeBoxInfo generateGameGridSizes(Context context,
   ...
   */
  public static ArrayList<GameCellInfo> generateGameCellInfo(Context context, int x_row, int y_row,
   ...
   */
  public static ArrayList<GameBombDirections> generatePossibleDirections(int x_rows, int y_columns,
                                                                         int index) {
  ...
  public static int generateChildOrbIndex(GameCellInfo gameCellInfo,
                                          GameBombDirections directions) {
