...
public class SplashActivity extends ActionBarActivity
    implements View.OnClickListener, ExitAlertDialogCreator.ButtonOnClickListener {
  ...
  public void onBackPressed() {
    if (mBackDialog == null || !mBackDialog.isShowing()) {
      mBackDialog =
          ExitAlertDialogCreator.createDialog(mBackDialogEntries, mBackDialogTitle, this, false);
      mBackDialog.show();
    } else {
      super.onBackPressed();
    }
