 ...
 */
public class SavedGamesRecycleAdapter
    extends RecyclerView.Adapter<SavedGamesRecycleAdapter.ViewHolder> {

  private ArrayList<SavedGamesEntity> dataSet;
  private SavedGamesSelectionInterface savedGamesSelectionInterface;
  private Context context;

  public SavedGamesRecycleAdapter(Context context,
                                  SavedGamesSelectionInterface savedGamesSelectionInterface,
   ...
   */
  private static void updateColorView(PlayColorValues colorValues, TextView mTextView,
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.saved_games_layout_item, parent, false);
    ...
    for (int i = 1; i <= dataSet.get(position).getGamePlayerInfos().size(); i++) {
      ...
      childParam.setMargins(
          ...
          context.getResources()
              .getDimensionPixelSize(R.dimen.saved_games_item_player_info_margin));
  ...
  public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ViewHolder(View itemView) {
      ...
      mGamePlayerInfoContainer =
          (LinearLayout) itemView.findViewById(R.id.saved_games_item_playerInfo);
      ...
      switch (v.getId()) {
        case R.id.saved_games_item_delete:
          ...
          boolean deleteStatus =
              ChainReactionDBOpsHelper.getDBInstance(context).deleteGame(toDelId);
          if (deleteStatus) {
