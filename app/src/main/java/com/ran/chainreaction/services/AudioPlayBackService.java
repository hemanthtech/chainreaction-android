...
public class AudioPlayBackService extends Service
  ...
  public void viewVisible(boolean isVisible) {
    if (isVisible &&
        ChainReactionPreferences.getSoundPreference(this) != SoundPreferenceValues.NO_SOUND) {
      initializeMediaPlayer();
    } else {
      resetMediaPlayer();
  ...
  private void updateCurrentStreamVolume() {
    ...
    } else if (ChainReactionPreferences.getSoundPreference(this) ==
        SoundPreferenceValues.MEDIUM_SOUND) {
