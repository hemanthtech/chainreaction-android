...
public class ChainReactionPreferences {
  ...
  public static final SoundPreferenceValues SOUND_KEY_DEFAULT_VALUE =
      SoundPreferenceValues.FULL_SOUND;
  ...
  public static SoundPreferenceValues getSoundPreference(Context context) {
    ...
    SharedPreferences sharedPreferences =
        context.getSharedPreferences(APP_PREFERENCE_KEY, Context.MODE_PRIVATE);
    int soundIndex = sharedPreferences.getInt(SOUND_KEY,
        SoundPreferenceValues.getIndex(SOUND_KEY_DEFAULT_VALUE));
  ...
  public static PlayColorValues getPlayerColorPreference(Context context) {
    ...
    SharedPreferences sharedPreferences =
        context.getSharedPreferences(APP_PREFERENCE_KEY, Context.MODE_PRIVATE);
    int colorIndex = sharedPreferences.getInt(PLAY_COLOR_KEY,
        PlayColorValues.getIndex(PLAY_COLOR_KEY_DEFAULT_VALUE));
  ...
  public static MusicValues getMusicPreference(Context context) {
    ...
    SharedPreferences sharedPreferences =
        context.getSharedPreferences(APP_PREFERENCE_KEY, Context.MODE_PRIVATE);
    int musicIndex =
        sharedPreferences.getInt(MUSIC_KEY, MusicValues.getIndex(MUSIC_KEY_DEFAULT_VALUE));
  ...
  public static GridSizeValues getGridSizePreference(Context context) {
    ...
    SharedPreferences sharedPreferences =
        context.getSharedPreferences(APP_PREFERENCE_KEY, Context.MODE_PRIVATE);
    int gridIndex =
        sharedPreferences.getInt(GRIDSIZE_KEY, GridSizeValues.getIndex(GRID_KEY_DEFAULT_VALUE));
  ...
  public static NoPlayerValues getPlayerNoReference(Context context) {
    ...
    SharedPreferences sharedPreferences =
        context.getSharedPreferences(APP_PREFERENCE_KEY, Context.MODE_PRIVATE);
    int playerIndex =
        sharedPreferences.getInt(PLAYERNO_KEY, NoPlayerValues.getIndex(PLAYERNO_KEY_DEFAULT_VALUE));
