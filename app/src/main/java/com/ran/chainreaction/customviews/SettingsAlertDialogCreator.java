...
public class SettingsAlertDialogCreator {
  ...
  private static void instantiateColorDialog(final Context context) {
    ...
    final ImageView mSelectedColorView =
        (ImageView) mTitleView.findViewById(R.id.settings_color_selected);
    ...
    mBuilder.setPositiveButton(R.string.dialog_color_settings_ok,
        new DialogInterface.OnClickListener() {
          @Override
          public void onClick(DialogInterface dialog, int which) {
    ...
    mBuilder.setNegativeButton(R.string.dialog_color_settings_reset,
        new DialogInterface.OnClickListener() {
          @Override
          public void onClick(DialogInterface dialog, int which) {
            settingsPreferenceDialog.dismiss();
            Toast.makeText(context, R.string.settings_save_color_toast_reset, Toast.LENGTH_SHORT)
                .show();
          }
        });
    settingsPreferenceDialog = mBuilder.create();
   ...
   */
  private static void updateColorView(int index, ImageView mImageView, Drawable drawable,
                                      Context context) {
    int colorId;
    switch (index) {
      case 0:
