...
public class SoundSettingsView extends ImageView implements View.OnClickListener,
  ...
  private ServiceConnection mAudioServiceConnection = new ServiceConnection() {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
      AudioPlayBackService.LocalAudioBinder mLocalBinder =
          (AudioPlayBackService.LocalAudioBinder) service;
  ...
  private void initView() {
    ...
    viewContext.getSharedPreferences(ChainReactionPreferences.APP_PREFERENCE_KEY,
