...
public class GameWinDialogCreator {
    ...
    public static AlertDialog createDialog(final Context context, GamePlayerInfo playerInfo) {
        ...
        LinearLayout parentLayout = (LinearLayout) layoutInflater.inflate(R.layout.dialog_game_win, null);
        ...
        String text = String.format(context.getResources().getString(R.string.player_win_message), playerInfo.getPlayerName());
