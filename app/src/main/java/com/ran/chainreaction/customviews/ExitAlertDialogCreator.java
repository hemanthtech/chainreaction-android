...
public class ExitAlertDialogCreator {
    ...
    public static AlertDialog createDialog(String[] buttonNames, String title, final Context context) {
        ...
        LinearLayout parentTitleLayout = (LinearLayout) layoutInflater.inflate(R.layout.alertdialog_parent_title, null);
        ...
        int verticalPadding = (int) context.getResources().getDimension(R.dimen.alert_dialog_padding_vetical);
        int horizontalPadding = (int) context.getResources().getDimension(R.dimen.alert_dialog_padding_horizantal);
        ...
        for (int k = 0; k < buttonNames.length; k++) {
            ...
            button.setBackgroundColor(context.getResources().getColor(R.color.alertDialog_buttons_background));
